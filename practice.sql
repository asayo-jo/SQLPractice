...
FROM
  countries
WHERE
  life_expectancy IS NOT NULL OR indep_year IS NOT NULL
ORDER BY
  life_expectancy DESC, indep_year DESC;
...
GROUP BY 
  countries.name
HAVING AVG(celebrities.age) IS NOT NULL
ORDER BY 
